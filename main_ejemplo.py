...
def encrypt_data_key(key_client, filename):
...
def encrypt_file(client_name, filename):
    ...
    data_key_encrypted, data_key_plaintext = encrypt_data_key(key_client, upload_path)
...
def key_rotation(client_name):
    ...
    #MIGUEL: How to decode the password???
    ...
    for filename in os.listdir(encrypted_path):
        ...
        data_key_plaintext = decrypt_data_key(data_key_encrypted, oldKeyClient)
        ...
        data_key_encrypted, data_key_plaintext = encrypt_data_key(newKeyClient, keyrotation_path)
...
encrypt_file(nameClient, fileName)
